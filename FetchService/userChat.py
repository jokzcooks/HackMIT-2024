...
if __name__ == "__main__":
    ...
    summary2=("Hello kanika, a very outgoing, backend focused person with skillset in c, java, python. iNTEREST IN ENTREPRENEURSHIP. Want to build saas based platform.")
